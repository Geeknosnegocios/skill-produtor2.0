...
echo ""
echo "✅ 7 skills instaladas em $SKILLS_DIR"
echo ""
echo "Reinicie o Claude Code e use:"
echo "  /pesquisar-nicho    → validar nicho"
echo "  /modelar-produto    → modelar produto"
echo "  /criar-lowticket    → criar produto completo"
echo "  /cakto-setup        → montar funil Cakto"
echo ""
